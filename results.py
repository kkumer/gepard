...
# EIC12C  Fit to EICX + EICTSA + H1ZEUSindependentNEW  chi/dof=1769/1685

EIC12C = {
'EAL0G': 1.3130017509305651, 'KAPS': 1.3258808777738604, 'fix_ALPG': False,
'EDELM2S': 0.0, 'EPS': 2.0, 'EAL0S': 1.1563926745529287, 'KAPG': 0.0,
'fix_ETHIG': False, 'EPG': 2.0, 'EDELM2G': 0.0, 'SECG': -3.5339785856980961,
'EKAPG': 0.0, 'ESKEWG': 0.0, 'fix_KAPG': True, 'M02S': 0.18493408464192829,
'NG': 0.5, 'fix_KAPS': False, 'SECS': -0.083289212683404223, 'EKAPS': 0.0,
'NS': 0.152, 'fix_PG': True, 'ALPS': 0.10118892388196057, 'fix_EM02G': False,
'fix_DELM2S': True, 'SKEWG': 0.0, 'fix_EM02S': False, 'SKEWS': 0.0, 'fix_THIS':
False, 'fix_ESKEWS': True, 'fix_ETHIS': False, 'fix_NG': True, 'THIS':
-0.030484626598628817, 'fix_EDELM2S': True, 'fix_NS': True, 'fix_THIG': False,
'fix_DELB': True, 'THIG': 1.3584088775058407, 'fix_EDELM2G': True, 'fix_EPG':
True, 'fix_ALPS': False, 'ETHIG': -1.0300364557835258, 'ESECS':
-0.083279084956232791, 'fix_EAL0G': False, 'fix_SECG': False, 'ETHIS':
-0.029543031440206795, 'ESECG': 0.0, 'fix_EPS': True, 'fix_EAL0S': False,
'fix_SECS': False, 'PS': 2.0, 'EALPG': 0.050000000000000003, 'EM02S':
0.10000133514361857, 'fix_AL0S': True, 'fix_EALPG': True, 'fix_M02G': False,
'EALPS': 0.033854885285005409, 'ESKEWS': 0.0, 'EM02G': 0.20000000000000004,
'PG': 2.0, 'fix_EALPS': False, 'limit_M02G': (0.10000000000000001, 1.5),
'fix_M02S': False, 'fix_DELM2G': True, 'fix_AL0G': True, 'AL0S': 1.1575,
'DELB': 0.0, 'fix_ESECS': False, 'fix_PS': True, 'limit_EM02S':
(0.10000000000000001, 1.5), 'fix_ESECG': True, 'AL0G': 1.2473000000000001,
'limit_EM02G': (0.10000000000000001, 1.5), 'limit_M02S': (0.10000000000000001,
1.5), 'M02G': 0.1635748425069849, 'fix_SKEWG': True, 'DELM2S': 0.0,
'fix_ESKEWG': True, 'ALPG': -0.054586016663101311, 'fix_SKEWS': True, 'DELM2G':
0.0}

EIC12Ccov = {
('M02S', 'ALPS'): 1.0252529301814763e-05, ('M02G', 'M02S'):
-4.4235484272591935e-06, ('M02S', 'EM02S'): 0.0, ('M02G', 'SECS'):
3.5016502381807296e-07, ('ETHIS', 'ESECS'): 3.0609921594081357e-06, ('KAPS',
'M02G'): 3.9844412609516622e-05, ('ALPG', 'ALPG'): 9.6835086350664478e-07,
('ETHIS', 'THIS'): -1.1415666599087329e-08, ('EM02S', 'SECS'): 0.0, ('ESECS',
'ETHIG'): 0.00018915821391781329, ('M02S', 'EAL0G'): -4.7556349473428999e-05,
('ESECS', 'ALPG'): 4.7445696462197818e-06, ('EM02G', 'EM02G'):
0.26000000000000006, ('M02S', 'SECG'): 1.7610707094522663e-05, ('KAPS',
'ETHIS'): 2.1930067346347244e-05, ('KAPS', 'M02S'): -3.7664417131479637e-05,
('SECS', 'THIS'): 6.6499192396801814e-09, ('THIS', 'ETHIS'):
-1.1415666599087329e-08, ('ETHIS', 'M02S'): -1.5042940735900081e-06, ('M02G',
'EAL0S'): -1.3890241366511964e-05, ('ETHIS', 'KAPS'): 2.1930067346347244e-05,
('EM02G', 'ALPS'): 0.0, ('EALPS', 'ESECS'): -8.8178701133739559e-06, ('EALPS',
'EAL0S'): 3.4144659971823614e-05, ('EALPS', 'ETHIS'): -2.4284694268486834e-06,
('EM02S', 'ALPS'): 0.0, ('SECG', 'ESECS'): -2.1876080771774687e-05, ('ETHIG',
'KAPS'): 0.0014906968749213451, ('EAL0G', 'ETHIG'): 0.003140147602519561,
('ETHIG', 'THIS'): -1.2112743343944048e-06, ('THIS', 'ALPG'):
-1.6871129736824171e-08, ('EAL0S', 'THIG'): -3.401688677481907e-05, ('SECS',
'SECS'): 1.2987245037481889e-07, ('ETHIG', 'ALPS'): -0.00051096405156827443,
('ALPG', 'EAL0S'): -1.3265507260753946e-05, ('KAPS', 'EM02S'): 0.0, ('EALPS',
'KAPS'): -6.9664655230106408e-05, ('THIS', 'M02S'): 2.3984444949205404e-08,
('ESECS', 'EAL0G'): 4.1797140126370298e-05, ('EAL0S', 'THIS'):
8.9063759802723709e-08, ('ESECS', 'ETHIS'): 3.0609921594081357e-06, ('M02G',
'M02G'): 1.4014398145866641e-05, ('THIG', 'ESECS'): 1.1729488909915557e-05,
('SECS', 'EM02G'): 0.0, ('SECG', 'M02G'): -2.5147699057352256e-05, ('EAL0G',
'EAL0S'): -0.00016714474881182362, ('SECS', 'ETHIS'): -4.6310755725269044e-09,
('EAL0S', 'EALPS'): 3.4144659971823614e-05, ('M02S', 'THIG'):
-8.8719638978830705e-06, ('EM02G', 'SECS'): 0.0, ('EM02G', 'ETHIG'): 0.0,
('EALPS', 'THIG'): -2.4325752903552812e-05, ('THIS', 'ETHIG'):
-1.2112743343944048e-06, ('EAL0G', 'THIS'): -4.4235218540226121e-07, ('M02G',
'EAL0G'): 2.5295697270541115e-05, ('THIG', 'ETHIG'): 0.00041239989638308146,
('SECG', 'THIS'): -5.4565245721299834e-08, ('ETHIS', 'SECG'):
-6.3039047109880007e-06, ('EALPS', 'EAL0G'): -0.00016279071848132544, ('ETHIS',
'SECS'): -4.6310755725269044e-09, ('EM02G', 'THIG'): 0.0, ('EALPS', 'THIS'):
5.8281018103113447e-08, ('SECG', 'EALPS'): 4.561072527754041e-05, ('EM02S',
'THIG'): 0.0, ('ALPS', 'M02G'): -6.0255985151182943e-06, ('ALPS', 'EAL0S'):
2.4039997526452663e-05, ('SECG', 'EM02G'): 0.0, ('EAL0G', 'EM02G'): 0.0,
('EALPS', 'M02S'): 1.0817148611120058e-05, ('EM02S', 'THIS'): 0.0, ('SECS',
'ALPS'): 3.6643954963820406e-07, ('SECG', 'ALPS'): 3.9843041743049234e-05,
('ALPS', 'ALPS'): 3.4311743347945458e-05, ('EALPS', 'EM02S'): 0.0, ('KAPS',
'SECG'): -0.00016260479422394852, ('ALPG', 'THIS'): -1.6871129736824171e-08,
('THIG', 'EM02S'): 0.0, ('EM02G', 'ESECS'): 0.0, ('SECS', 'KAPS'):
3.6070984026736278e-08, ('EAL0S', 'ETHIG'): -0.00064217588476243566, ('M02S',
'M02G'): -4.4235484272591935e-06, ('THIG', 'THIG'): 2.7945945102447445e-05,
('ALPS', 'ETHIG'): -0.00051096405156827443, ('EAL0S', 'EM02G'): 0.0, ('M02S',
'THIS'): 2.3984444949205404e-08, ('EM02S', 'M02G'): 0.0, ('ALPG', 'ETHIG'):
0.00016737183559985955, ('M02G', 'ETHIS'): 1.655269248031576e-06, ('EAL0S',
'KAPS'): -0.00020024687942256819, ('EAL0G', 'EM02S'): 0.0, ('EM02G', 'SECG'):
0.0, ('ALPG', 'EAL0G'): 4.2501912112169124e-05, ('M02S', 'EALPS'):
1.0817148611120058e-05, ('KAPS', 'ESECS'): 7.4250577919096871e-05, ('M02G',
'SECG'): -2.5147699057352256e-05, ('EM02G', 'ETHIS'): 0.0, ('EM02S', 'EM02S'):
3.7383985667617615e-06, ('KAPS', 'EM02G'): 0.0, ('ALPG', 'ALPS'):
-8.2217626253223367e-06, ('ETHIS', 'ALPG'): 1.3739076230488396e-06, ('ALPS',
'ESECS'): -7.818677376774423e-06, ('SECS', 'ESECS'): -1.1729262190352797e-08,
('THIS', 'EM02G'): 0.0, ('M02S', 'SECS'): -1.272903646509934e-08, ('ALPG',
'EALPS'): -8.8997949692276e-06, ('EAL0S', 'SECG'): 6.2870101467457726e-05,
('EM02S', 'ETHIG'): 0.0, ('THIG', 'SECG'): -3.7014534643955832e-05, ('SECG',
'SECS'): -5.4623702032188024e-07, ('EALPS', 'M02G'): -8.7358912787677206e-06,
('ETHIG', 'THIG'): 0.00041239989638308146, ('EAL0G', 'M02G'):
2.5295697270541115e-05, ('ALPS', 'ALPG'): -8.2217626253223367e-06, ('SECS',
'M02G'): 3.5016502381807296e-07, ('EM02G', 'ALPG'): 0.0, ('ETHIG', 'SECS'):
2.3834045022350097e-07, ('EAL0S', 'EAL0G'): -0.00016714474881182362, ('ALPS',
'M02S'): 1.0252529301814763e-05, ('EALPS', 'ALPS'): 3.05587623513275e-05,
('ALPG', 'EM02S'): 0.0, ('ALPG', 'M02S'): -3.6227093582598353e-06, ('KAPS',
'THIG'): 8.5622976410123464e-05, ('EAL0G', 'ETHIS'): 1.1486288194278959e-05,
('ALPG', 'ETHIS'): 1.3739076230488396e-06, ('M02G', 'ETHIG'):
0.00016492388915476696, ('ETHIS', 'EALPS'): -2.4284694268486834e-06, ('M02G',
'THIS'): 8.7147596752044764e-08, ('EM02S', 'SECG'): 0.0, ('M02S', 'ETHIS'):
-1.5042940735900081e-06, ('THIG', 'EAL0S'): -3.401688677481907e-05, ('EM02S',
'KAPS'): 0.0, ('ALPS', 'KAPS'): -5.7183600718047786e-05, ('EALPS', 'EM02G'):
0.0, ('KAPS', 'EAL0G'): 0.00033472381202722453, ('SECS', 'EALPS'):
-6.1123201367494666e-08, ('ALPG', 'KAPS'): 3.48204076088342e-05, ('THIS',
'THIS'): 1.2635074285820813e-08, ('EM02S', 'EALPS'): 0.0, ('EM02G', 'M02G'):
0.0, ('ETHIS', 'M02G'): 1.655269248031576e-06, ('THIS', 'M02G'):
8.7147596752044764e-08, ('EALPS', 'SECS'): -6.1123201367494666e-08, ('ALPG',
'ESECS'): 4.7445696462197818e-06, ('THIG', 'SECS'): -3.1429072222579528e-07,
('EM02S', 'M02S'): 0.0, ('EAL0S', 'ETHIS'): -7.8919122562767343e-06, ('EM02G',
'EM02S'): 0.0, ('ESECS', 'THIS'): -3.8191304371782162e-08, ('THIG', 'M02S'):
-8.8719638978830705e-06, ('SECG', 'THIG'): -3.7014534643955832e-05, ('SECS',
'EAL0G'): -3.5660248221960717e-07, ('M02S', 'KAPS'): -3.7664417131479637e-05,
('ETHIG', 'SECG'): -0.00082128796970376366, ('SECS', 'EM02S'): 0.0, ('ESECS',
'M02S'): -5.1974358045494951e-06, ('ALPS', 'EAL0G'): -0.00014238774034205958,
('ETHIG', 'EM02G'): 0.0, ('THIG', 'M02G'): 4.0533590319579267e-06, ('ALPS',
'THIS'): 1.8318263494892516e-07, ('KAPS', 'THIS'): -2.4187218917993339e-07,
('SECG', 'ETHIS'): -6.3039047109880007e-06, ('ALPG', 'SECG'):
-1.5918787111936941e-05, ('THIG', 'ETHIS'): 3.3991199352337631e-06, ('ESECS',
'SECS'): -1.1729262190352797e-08, ('EM02S', 'ESECS'): 0.0, ('ALPS', 'EM02S'):
0.0, ('EM02G', 'THIS'): 0.0, ('ESECS', 'ESECS'): 1.112200043188203e-05,
('EM02G', 'KAPS'): 0.0, ('M02S', 'ETHIG'): -0.00018946689642948905, ('KAPS',
'SECS'): 3.6070984026736278e-08, ('THIS', 'SECS'): 6.6499192396801814e-09,
('ETHIG', 'EAL0S'): -0.00064217588476243566, ('M02S', 'EM02G'): 0.0, ('M02G',
'EALPS'): -8.7358912787677206e-06, ('ALPG', 'M02G'): 3.9376621428823124e-06,
('KAPS', 'ALPG'): 3.48204076088342e-05, ('EALPS', 'SECG'):
4.561072527754041e-05, ('EALPS', 'EALPS'): 4.0582771518541171e-05, ('SECG',
'KAPS'): -0.00016260479422394852, ('EAL0G', 'SECG'): -0.00020686112314743108,
('THIG', 'EALPS'): -2.4325752903552812e-05, ('M02S', 'M02S'):
4.3300517498704047e-06, ('EAL0S', 'SECS'): -3.4134511174435431e-08, ('ALPS',
'SECS'): 3.6643954963820406e-07, ('SECG', 'EM02S'): 0.0, ('THIG', 'THIS'):
-1.5989002030589415e-07, ('EAL0S', 'ALPG'): -1.3265507260753946e-05, ('ESECS',
'EM02S'): 0.0, ('EAL0G', 'THIG'): 0.00010917689206343067, ('ETHIG', 'M02S'):
-0.00018946689642948905, ('ALPS', 'THIG'): -2.2174692884704925e-05, ('SECG',
'M02S'): 1.7610707094522663e-05, ('SECG', 'ETHIG'): -0.00082128796970376366,
('EAL0G', 'ESECS'): 4.1797140126370298e-05, ('ESECS', 'SECG'):
-2.1876080771774687e-05, ('THIG', 'EM02G'): 0.0, ('EAL0G', 'M02S'):
-4.7556349473428999e-05, ('EALPS', 'ETHIG'): -0.00058586830973410069, ('ESECS',
'ALPS'): -7.818677376774423e-06, ('SECS', 'ALPG'): 2.106907194475194e-08,
('KAPS', 'ETHIG'): 0.0014906968749213451, ('ALPS', 'EALPS'):
3.05587623513275e-05, ('KAPS', 'EALPS'): -6.9664655230106408e-05, ('THIG',
'ALPS'): -2.2174692884704925e-05, ('EM02G', 'EAL0S'): 0.0, ('EALPS', 'ALPG'):
-8.8997949692276e-06, ('THIS', 'SECG'): -5.4565245721299834e-08, ('ETHIS',
'EM02G'): 0.0, ('THIS', 'EALPS'): 5.8281018103113447e-08, ('EAL0G', 'EAL0G'):
0.0009436514423027258, ('EM02G', 'M02S'): 0.0, ('EAL0G', 'KAPS'):
0.00033472381202722453, ('ETHIS', 'ETHIS'): 9.8069342525383435e-07, ('KAPS',
'ALPS'): -5.7183600718047786e-05, ('SECG', 'ALPG'): -1.5918787111936941e-05,
('M02G', 'THIG'): 4.0533590319579267e-06, ('THIS', 'ALPS'):
1.8318263494892516e-07, ('KAPS', 'KAPS'): 0.0005890334297525752, ('EM02S',
'EAL0G'): 0.0, ('EM02S', 'ETHIS'): 0.0, ('SECS', 'SECG'):
-5.4623702032188024e-07, ('KAPS', 'EAL0S'): -0.00020024687942256819, ('ETHIG',
'ALPG'): 0.00016737183559985955, ('THIS', 'THIG'): -1.5989002030589415e-07,
('EAL0S', 'M02S'): 1.4120717222140308e-05, ('THIS', 'ESECS'):
-3.8191304371782162e-08, ('SECG', 'SECG'): 0.00010602207325999206, ('THIS',
'EAL0S'): 8.9063759802723709e-08, ('SECG', 'EAL0S'): 6.2870101467457726e-05,
('ETHIG', 'M02G'): 0.00016492388915476696, ('ETHIG', 'ETHIS'):
5.3030667943238336e-05, ('EM02S', 'ALPG'): 0.0, ('ESECS', 'KAPS'):
7.4250577919096871e-05, ('M02G', 'ALPG'): 3.9376621428823124e-06, ('ESECS',
'THIG'): 1.1729488909915557e-05, ('M02G', 'EM02S'): 0.0, ('SECS', 'ETHIG'):
2.3834045022350097e-07, ('EM02G', 'EALPS'): 0.0, ('ALPG', 'EM02G'): 0.0,
('EAL0S', 'M02G'): -1.3890241366511964e-05, ('ETHIG', 'EALPS'):
-0.00058586830973410069, ('ALPS', 'ETHIS'): -2.1827116491937716e-06, ('ETHIS',
'ALPS'): -2.1827116491937716e-06, ('THIS', 'KAPS'): -2.4187218917993339e-07,
('SECS', 'M02S'): -1.272903646509934e-08, ('EAL0S', 'ESECS'):
-2.6920762985938112e-05, ('ETHIG', 'EAL0G'): 0.003140147602519561, ('THIG',
'KAPS'): 8.5622976410123464e-05, ('M02S', 'ALPG'): -3.6227093582598353e-06,
('ETHIG', 'ETHIG'): 0.012001567559456149, ('EAL0G', 'ALPS'):
-0.00014238774034205958, ('M02G', 'EM02G'): 0.0, ('ESECS', 'EM02G'): 0.0,
('M02G', 'KAPS'): 3.9844412609516622e-05, ('EAL0S', 'EM02S'): 0.0, ('ETHIS',
'ETHIG'): 5.3030667943238336e-05, ('EAL0G', 'ALPG'): 4.2501912112169124e-05,
('EM02S', 'EAL0S'): 0.0, ('ALPS', 'EM02G'): 0.0, ('M02G', 'ALPS'):
-6.0255985151182943e-06, ('SECS', 'EAL0S'): -3.4134511174435431e-08, ('EAL0S',
'ALPS'): 2.4039997526452663e-05, ('EM02S', 'EM02G'): 0.0, ('SECS', 'THIG'):
-3.1429072222579528e-07, ('ETHIS', 'EAL0S'): -7.8919122562767343e-06, ('THIS',
'EM02S'): 0.0, ('EAL0G', 'EALPS'): -0.00016279071848132544, ('ESECS', 'EALPS'):
-8.8178701133739559e-06, ('THIS', 'EAL0G'): -4.4235218540226121e-07, ('SECG',
'EAL0G'): -0.00020686112314743108, ('THIG', 'EAL0G'): 0.00010917689206343067,
('ETHIG', 'ESECS'): 0.00018915821391781329, ('M02S', 'EAL0S'):
1.4120717222140308e-05, ('EAL0G', 'SECS'): -3.5660248221960717e-07, ('ETHIS',
'EAL0G'): 1.1486288194278959e-05, ('M02G', 'ESECS'): 5.6727956729158371e-06,
('ETHIS', 'THIG'): 3.3991199352337631e-06, ('ESECS', 'M02G'):
5.6727956729158371e-06, ('ALPS', 'SECG'): 3.9843041743049234e-05, ('M02S',
'ESECS'): -5.1974358045494951e-06, ('EAL0S', 'EAL0S'): 7.9386971243583621e-05,
('ETHIS', 'EM02S'): 0.0, ('THIG', 'ALPG'): 7.2998973749634731e-06, ('EM02G',
'EAL0G'): 0.0, ('ALPG', 'SECS'): 2.106907194475194e-08, ('ESECS', 'EAL0S'):
-2.6920762985938112e-05, ('ETHIG', 'EM02S'): 0.0, ('ALPG', 'THIG'):
7.2998973749634731e-06}
