...
parstemplate = ('Nsea', 'alS', 'alpS', 'MS', 'rS', 'bS', 'Nv', 'alv', 'alpv', 'Mv', 'rv', 'bv', 
...
KMM12 = {'tMv': 3.5226287743963187, 'rS': 1.0, 'limit_tbv':
...
KMM12cov = {('MC', 'Mv'): -0.45030621597105341, ('trv', 'SECG'):
...
nloNLOMSParameters = {
     "NS": 0.1678001855399918,
     "AL0S": 1.1283507054223731,
     "ALPS": 0.15,
     "M02S": 0.5903387154604478,
     "DELM2S": 0.,
     "PS": 2.,
     "SECS": 0.04146596548203286,
     "KAPS": 0.,
     "SKEWS": 0.,
     "AL0G": 1.0990016751643479,
     "ALPG": 0.15,
     "M02G": 0.7,
     "DELM2G": 0.,
     "PG": 2.,
     "SECG": 0.02028213804881288,
     'THIG': 0.,
     'THIS': 0.,
     "KAPG": 0.,
     "SKEWG": 0.}
...
KMM12p = {'AL0G': 1.2473,
 ...
 'KAPG': 0.0,
 'KAPS': 0.0,
 'M02G': 0.7000000000000001,
 'M02S': 0.46230000000000004,
 'MC': 6.7416,
 'Mpi': 0.0126,
 'Mv': 0.7548,
 'NS': 0.152,
 ...
 'SKEWG': 0.0,
 'SKEWS': 0.0,
 'THIG': 0.9447000000000001,
 'THIS': -0.1383,
 'bv': 0.337,
 'C': -1.3962,
 'rpi': 3.3218,
 'rv': 1.3171000000000002,
 'tMv': 27.3551,
 'tbv': 3.331,'tNv' : 0.6, 
 'trv': 0.012100000000000001}

KMM12b = {"NS" : 0.152, "AL0S" : 1.1575, "ALPS" : 0.15, 
 "M02S" : 0.4466, "DELM2S" : 0., "PS" : 2., "SECS" : -0.4616, 
 "THIS" : 0.0952, "SKEWS" : 0., "KAPS" : 0., "AL0G" : 1.2473, 
 "ALPG" : 0.15, "M02G" : 0.7000000000000001, "DELM2G" : 0., 
 "PG" : 2., "SECG" : -2.5356, "THIG" : 0.9664, "SKEWG" : 0., 
 "KAPG" : 0., "rv" : 0.8586, "Mv" : 1.2687000000000002, 
 "bv" : 0.4091, "C" : 2.5122, "MC" : 0.8669, "trv" : 0.9513, 'tNv' : 0.6, 
 "tMv" : 1.6837, "tbv" : 1.0211000000000001, "rpi" : 3.2866, 
 "Mpi" : 19.6189}
...
# KM15
KM15 = {'tMv': 3.992860161655587, 
'rS': 1.0, 'limit_tbv': (0.4, 5.0), 'fix_tal': True,
'alv': 0.43, 'fix_Mv': False, 'fix_Mpi': False, 'tal': 0.43, 'fix_bv':
False, 'Mpi': 3.999999852084612, 'Nv': 1.35, 'fix_trv': False,
'limit_C': (-10.0, 10.0), 'MS': 0.707, 'rv': 0.918393047884448,
'fix_tNv': True, 'fix_MC': False, 'Nsea': 0.0, 'fix_MS': True,
'limit_trv': (0.0, 8.0), 'limit_rv': (0.0, 8.0), 'alS': 1.13, 'rpi':
2.6463144464701536, 'fix_bS': True, 'alpS': 0.15, 'limit_Mpi': (0.4,
    4.0), 'C': 2.7678681812890016, 'tNv': 0.6, 'limit_Mv': (0.4, 4.0),
'limit_tMv': (0.4, 4.0), 'limit_bS': (0.4, 5.0), 'bS': 2.0, 'fix_alpv':
True, 'tbv': 0.4000000003259146, 'fix_alv': True, 'bv':
0.40000206775282354, 'Mv': 0.7892078914770488, 'fix_Nv': True,
'fix_tbv': False, 'alpv': 0.85, 'fix_rpi': False, 'talp': 0.85, 'MC':
1.2040519863464496, 'fix_Nsea': True, 'fix_alpS': True, 'fix_C': False,
'limit_bv': (0.4, 5.0), 'fix_talp': True, 'limit_MC': (0.4, 4.0),
'fix_alS': True, 'limit_rpi': (-8, 8.0), 'fix_rS': True, 'fix_rv':
False, 'fix_tMv': False, 'trv': 0.881085721967267,
'fix_ESKEWG': True, 'EPS': 2.0, 'fix_ESKEWS': True, 'EPG': 2.0,
'fix_ETHIG': True, 'EM02G': 0.7, 'fix_PG': True, 'EDELM2S': 0.0,
'SKEWG': 0.0, 'SKEWS': 0.0, 'fix_THIS': False, 'fix_ETHIS': True,
'fix_ND': True, 'fix_NG': True, 'THIS': -0.36618269477432946,
'fix_EDELM2S': True, 'fix_NS': True, 'fix_THIG': False, 'THIG':
0.9052207712570559, 'fix_EDELM2G': True, 'PS': 2.0, 'EALPG': 0.15,
'M02D': 1.0, 'M02G': 0.7, 'fix_EALPG': True, 'fix_M02D': True,
'fix_M02G': True, 'EALPS': 0.15, 'M02S': 0.4818827240886959, 'PG': 2.0,
'fix_EALPS': True, 'fix_M02S': False, 'EDELM2G': 0.0, 'AL0S':
1.1575060246398083, 'fix_ESECS': True, 'fix_ESECG': True, 'AL0G':
1.247316701070471, 'AL0D': 0.5, 'limit_M02S': (0.3, 1.5), 'fix_SKEWG':
True, 'DELM2S': 0.0, 'limit_M02G': (0.3, 1.5), 'limit_M02D': (0.1,
    1.5), 'fix_SKEWS': True, 'DELM2G': 0.0, 'EAL0G': 1.1, 'KAPS': 0.0,
'fix_DELM2S': True, 'EAL0S': 1.0, 'KAPG': 0.0, 'fix_DELM2G': True,
'SECG': -2.990809378821039, 'fix_KAPG': True, 'ND': 1.0, 'NG': 0.5,
'SECS': 1.0707825621025808, 'NS': 0.15203911208796006, 'fix_KAPS':
True, 'fix_EM02G': True, 'fix_ALPS': True, 'fix_EM02S': True,
'fix_ALPG': True, 'fix_ALPD': True, 'ESKEWG': 0.0, 'fix_DELB': True,
'fix_EPG': True, 'ETHIG': 0.0, 'ESECS': 0.0, 'fix_EAL0G': True,
'fix_SECG': False, 'ETHIS': 0.0, 'ESECG': 0.0, 'fix_EPS': True,
'fix_EAL0S': True, 'fix_SECS': False, 'fix_AL0S': True, 'ESKEWS': 0.0,
'fix_AL0G': True, 'fix_AL0D': True, 'DELB': 0.0, 'fix_PS': True,
'limit_EM02S': (0.1, 1.5), 'limit_EM02G': (0.1, 1.5), 'ALPS': 0.15,
'EM02S': 1.0, 'ALPG': 0.15, 'ALPD': 1.0}

KM15cov = {('MC', 'Mv'): -0.02594163518434614,
('trv', 'SECG'): 0.0014142003722596157,
('C', 'tMv'): -0.004062954102389041,
('Mv', 'Mv'): 0.02640090784392837,
('SECG', 'MC'): -0.016680754139737287,
('tbv', 'SECG'): -5.075347859522649e-09,
('M02S', 'bv'): -1.2930273845222695e-07,
('rpi', 'Mv'): 7.445865824161803e-05,
('Mv', 'tbv'): -4.661960061091572e-10,
('MC', 'rv'): 0.01578140387344565,
('trv', 'C'): 0.012651806220145863,
('bv', 'M02S'): -1.2930273845222695e-07,
('C', 'Mpi'): -8.159313272535279e-07,
('SECS', 'THIS'): -0.0004047548716339479,
('THIG', 'tMv'): 0.005823031723216696,
('tMv', 'Mv'): 0.005256307459661219,
('THIG', 'bv'): -3.7772786284069746e-06,
('SECG', 'bv'): 8.07867800931409e-06,
('Mv', 'tMv'): 0.005256307459661219,
('Mpi', 'rv'): 1.45425612434003e-07,
('C', 'M02S'): -0.0008816643709868306,
('M02S', 'rv'): 5.469923994842397e-05,
('Mv', 'rv'): -0.012290036952889018,
('rpi', 'Mpi'): 4.825228855160387e-07,
('THIS', 'Mv'): -5.033867836050365e-05,
('bv', 'MC'): -5.578821258720149e-06,
('bv', 'THIG'): -3.7772786284069746e-06,
('SECS', 'SECS'): 0.0013678760984544146,
('rv', 'Mpi'): 1.45425612434003e-07,
('THIS', 'MC'): -3.026962507773301e-05,
('trv', 'trv'): 0.008359510574749244,
('SECG', 'rpi'): 0.0024614277943800444,
('rv', 'MC'): 0.01578140387344565,
('trv', 'bv'): 7.000021617173447e-07,
('bv', 'C'): 6.006339372802843e-06,
('SECS', 'Mpi'): -2.117127416765447e-09,
('rpi', 'tMv'): -0.0019655290502676374,
('tbv', 'THIG'): 2.271133863126967e-09,
('THIG', 'C'): -0.017865867120951024,
('SECG', 'rv'): -0.005955670378838681,
('M02S', 'THIG'): 9.150632043503929e-05,
('C', 'rv'): -0.03256937153363888,
('tbv', 'Mpi'): 1.8042617879299248e-13,
('rpi', 'bv'): -3.464023335126042e-08,
('SECG', 'THIS'): -6.669581675462293e-05,
('MC', 'tMv'): -0.0018548884356587398,
('rpi', 'MC'): -0.005244751098365945,
('SECG', 'trv'): 0.0014142003722596157,
('trv', 'tbv'): 4.793231472643217e-09,
('tbv', 'tbv'): 2.2245033424881974e-10,
('Mpi', 'THIG'): 1.715478391705654e-07,
('Mpi', 'MC'): 6.225043589507069e-07,
('M02S', 'SECG'): -0.0009775127714095814,
('bv', 'Mv'): 1.0094840358980426e-06,
('bv', 'bv'): 3.963741346671428e-07,
('rv', 'rpi'): -0.0013276285632216629,
('C', 'SECG'): 0.033654352813194545,
('Mpi', 'Mpi'): 7.873545334657349e-07,
('THIG', 'M02S'): 9.150632043503929e-05,
('THIG', 'trv'): -0.0005262161934405493,
('THIS', 'rpi'): -3.90376698570103e-06,
('tMv', 'THIS'): 5.412143134022421e-05,
('rv', 'THIS'): 1.515312476065655e-06,
('tMv', 'trv'): 0.004106729614827554,
('Mpi', 'tMv'): 5.453981166116738e-07,
('bv', 'tMv'): 6.526556204174418e-06,
('tMv', 'rpi'): -0.0019655290502676374,
('THIS', 'tMv'): 5.412143134022421e-05,
('M02S', 'THIS'): -2.2244202150602097e-05,
('SECG', 'tbv'): -5.075347859522649e-09,
('Mv', 'THIS'): -5.033867836050365e-05,
('Mv', 'bv'): 1.0094840358980426e-06,
('tMv', 'SECS'): -0.00020797936977697034,
('tbv', 'rpi'): 5.451745252948105e-09,
('MC', 'THIS'): -3.026962507773301e-05,
('trv', 'SECS'): -2.5278129968532353e-05,
('SECS', 'C'): 0.0003101653893109671,
('bv', 'Mpi'): -2.560788661991243e-10,
('tMv', 'MC'): -0.0018548884356587398,
('THIG', 'THIG'): 0.013822834364342609,
('MC', 'trv'): -0.0028279757740161987,
('THIG', 'rv'): 0.002626930938351509,
('trv', 'rpi'): 0.004279945983033046,
('THIS', 'M02S'): -2.2244202150602097e-05,
('M02S', 'SECS'): -6.75799181286118e-05,
('C', 'MC'): -0.17468251423431225,
('THIG', 'SECG'): -0.029461510488781505,
('THIG', 'Mv'): -0.0030497236004870584,
('SECG', 'SECS'): -0.00032210242204928956,
('MC', 'SECS'): -0.00025430411877771424,
('C', 'THIS'): 0.00010983962342799783,
('M02S', 'Mpi'): 4.818298508779657e-09,
('Mv', 'C'): 0.04628213859434837,
('rpi', 'THIS'): -3.90376698570103e-06,
('tbv', 'Mv'): -4.661960061091572e-10,
('tbv', 'M02S'): 9.449399039031395e-11,
('Mpi', 'Mv'): -3.002445396818728e-07,
('MC', 'tbv'): 3.1068014617934756e-09,
('THIS', 'tbv'): 2.5503168089137544e-11,
('rv', 'tMv'): -0.0021142802053868144,
('Mv', 'THIG'): -0.0030497236004870584,
('Mv', 'MC'): -0.02594163518434614,
('rv', 'bv'): -1.2177504463075054e-06,
('SECS', 'rpi'): -4.497229688103886e-05,
('bv', 'SECG'): 8.07867800931409e-06,
('M02S', 'C'): -0.0008816643709868306,
('tbv', 'trv'): 4.793231472643217e-09,
('Mv', 'Mpi'): -3.002445396818728e-07,
('SECS', 'tMv'): -0.00020797936977697034,
('tbv', 'THIS'): 2.5503168089137544e-11,
('trv', 'rv'): -0.0012787106843380035,
('C', 'tbv'): 4.2456012968436586e-10,
('SECG', 'Mpi'): -3.7486002740054515e-07,
('SECS', 'THIG'): -4.983293258985883e-05,
('THIG', 'SECS'): -4.983293258985883e-05,
('Mv', 'SECS'): -1.6080061445049554e-05,
('rpi', 'SECS'): -4.497229688103886e-05,
('tbv', 'rv'): 9.408192707983618e-10,
('MC', 'SECG'): -0.016680754139737287,
('bv', 'tbv'): -8.358890285660504e-13,
('SECG', 'THIG'): -0.029461510488781505,
('SECS', 'bv'): 9.636983136536941e-08,
('Mpi', 'trv'): 7.312525764588529e-08,
('rpi', 'tbv'): 5.451745252948105e-09,
('Mv', 'rpi'): 7.445865824161803e-05,
('THIG', 'tbv'): 2.271133863126967e-09,
('SECG', 'M02S'): -0.0009775127714095814,
('Mpi', 'THIS'): 1.8200827202922031e-09,
('Mpi', 'bv'): -2.560788661991243e-10,
('rv', 'C'): -0.03256937153363888,
('rv', 'Mv'): -0.012290036952889018,
('rpi', 'M02S'): -0.00021480860936390022,
('tMv', 'M02S'): 0.0003278638783166631,
('trv', 'M02S'): -0.00012610182596681073,
('C', 'trv'): 0.012651806220145863,
('tMv', 'THIG'): 0.005823031723216696,
('tMv', 'tMv'): 0.4462012493678579,
('rv', 'SECG'): -0.005955670378838681,
('Mpi', 'SECG'): -3.7486002740054515e-07,
('MC', 'C'): -0.17468251423431225,
('THIS', 'SECS'): -0.0004047548716339479,
('tbv', 'bv'): -8.358890285660504e-13,
('C', 'C'): 0.3431589181642893,
('SECS', 'trv'): -2.5278129968532353e-05,
('SECG', 'Mv'): 0.00732027013669366,
('rpi', 'trv'): 0.004279945983033046,
('THIG', 'rpi'): -0.000882260484568843,
('trv', 'MC'): -0.0028279757740161987,
('rpi', 'rpi'): 0.005444454401099867,
('Mpi', 'C'): -8.159313272535279e-07,
('rv', 'M02S'): 5.469923994842397e-05,
('rv', 'trv'): -0.0012787106843380035,
('MC', 'THIG'): 0.008358402237648445,
('M02S', 'M02S'): 0.0007553027866918687,
('trv', 'Mpi'): 7.312525764588529e-08,
('THIG', 'THIS'): 0.00010486878138957129,
('tbv', 'MC'): 3.1068014617934756e-09,
('tMv', 'C'): -0.004062954102389041,
('tbv', 'SECS'): -2.5866561921178647e-11,
('trv', 'tMv'): 0.004106729614827554,
('MC', 'bv'): -5.578821258720149e-06,
('THIS', 'C'): 0.00010983962342799783,
('tbv', 'C'): 4.2456012968436586e-10,
('rpi', 'THIG'): -0.000882260484568843,
('SECS', 'tbv'): -2.5866561921178647e-11,
('M02S', 'rpi'): -0.00021480860936390022,
('tMv', 'SECG'): -0.012101514885879955,
('THIS', 'trv'): -8.345208505022077e-07,
('THIG', 'Mpi'): 1.715478391705654e-07,
('M02S', 'tMv'): 0.0003278638783166631,
('SECS', 'Mv'): -1.6080061445049554e-05,
('MC', 'rpi'): -0.005244751098365945,
('Mpi', 'SECS'): -2.117127416765447e-09,
('rv', 'rv'): 0.007118159444798006,
('THIS', 'SECG'): -6.669581675462293e-05,
('SECS', 'SECG'): -0.00032210242204928956,
('THIG', 'MC'): 0.008358402237648445,
('rpi', 'C'): 0.005706463593693785,
('C', 'bv'): 6.006339372802843e-06,
('Mv', 'trv'): -0.0012796995329513669,
('Mv', 'M02S'): 6.127304574339615e-05,
('tMv', 'bv'): 6.526556204174418e-06,
('Mpi', 'rpi'): 4.825228855160387e-07,
('SECS', 'rv'): 7.419336010650417e-05,
('bv', 'SECS'): 9.636983136536941e-08,
('MC', 'M02S'): 0.0010445182465917701,
('THIS', 'bv'): -4.254946070760206e-08,
('THIS', 'THIG'): 0.00010486878138957129,
('bv', 'trv'): 7.000021617173447e-07,
('C', 'rpi'): 0.005706463593693785,
('tMv', 'Mpi'): 5.453981166116738e-07,
('Mpi', 'tbv'): 1.8042617879299248e-13,
('trv', 'THIG'): -0.0005262161934405493,
('rpi', 'rv'): -0.0013276285632216629,
('C', 'Mv'): 0.04628213859434837,
('Mv', 'SECG'): 0.00732027013669366,
('C', 'SECS'): 0.0003101653893109671,
('trv', 'Mv'): -0.0012796995329513669,
('M02S', 'MC'): 0.0010445182465917701,
('SECG', 'SECG'): 0.06474830951709193,
('MC', 'MC'): 0.1086068303189457,
('tbv', 'tMv'): -1.1088823299956844e-09,
('THIS', 'THIS'): 0.00012464479814190842,
('SECS', 'M02S'): -6.75799181286118e-05,
('M02S', 'trv'): -0.00012610182596681073,
('M02S', 'Mv'): 6.127304574339615e-05,
('MC', 'Mpi'): 6.225043589507069e-07,
('C', 'THIG'): -0.017865867120951024,
('rv', 'SECS'): 7.419336010650417e-05,
('THIS', 'rv'): 1.515312476065655e-06,
('SECS', 'MC'): -0.00025430411877771424,
('bv', 'THIS'): -4.254946070760206e-08,
('rv', 'tbv'): 9.408192707983618e-10,
('trv', 'THIS'): -8.345208505022077e-07,
('rv', 'THIG'): 0.002626930938351509,
('bv', 'rv'): -1.2177504463075054e-06,
('M02S', 'tbv'): 9.449399039031395e-11,
('SECG', 'tMv'): -0.012101514885879955,
('tMv', 'rv'): -0.0021142802053868144,
('SECG', 'C'): 0.033654352813194545,
('Mpi', 'M02S'): 4.818298508779657e-09,
('rpi', 'SECG'): 0.0024614277943800444,
('bv', 'rpi'): -3.464023335126042e-08,
('tMv', 'tbv'): -1.1088823299956844e-09,
('THIS', 'Mpi'): 1.8200827202922031e-09}
