...
# DIS
th.m.parameters['NS'] = KMM12['NS']
th.m.parameters['AL0S'] = KMM12['AL0S']
th.m.parameters['AL0G'] = KMM12['AL0G']
...
f = Fitter.FitterMinuit(GLO15 + data[116] + data[117] + data[101][::3] + data[102][::3], th)
f.minuit.tol = 80
