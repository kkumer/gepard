...
def test_c1():
    ...
    t = Approach.BMK(m)
    t.m.parameters.update(dvmppars)
    t.m.g.init()
    t.m.g.newcall = 1
    t.m.g.parint.pid = 2
    ...
    # quark part
    assert_almost_equal(aux[0]/100, (30.3836+9.2856j)/100, 5)
    # "pure singlet" part
    assert_almost_equal(aux[1]/100, (-0.496221+3.85004j)/100, 6)
    # gluon part
    assert_almost_equal(aux[2]/100, (35.2725+34.0699j)/100, 6)
...
def test_gepardTFFsNLO():
    ...
    assert_almost_equal(im/1e4, 22676.063/1e4, 5)
