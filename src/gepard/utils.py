...
def listchis(ths, Q2cut=1., Q2max=1.e3, nsets=10, out='chis'):
    ...
    #ptssets[0] = [UNP5points, ALTGLO5points, data[25], data[8], XLUwpoints, XUUwpoints, TSA1points, BTSApoints, TPpoints]
    sets = {}
    sets[0] = [('H1ZEUS', 'X_DVCS', H1ZEUS), ('HERMES', 'ALUI', ALUIpts),
            ('HERMES', 'AC', ACpts), ('CLAS', 'ALU', CLASpts),
            ('Hall A', 'XLUw', XLUwpoints), ('Hall A', 'XUUw', XUUwpoints),
    ...
    sets[5] = [
            ...
            ('CLAS', 'XLUw_s1', C_XLUwpts), ('CLAS', 'XUUw_c0', C_XUUw0pts),
    ...
    sets[9] = [
	    ...
	    ('CLAS', 'XUUw_c0', C_XUUw0pts),
            ('CLAS', 'XUUw_c1', C_XUUw1pts),
            ('HallA 15', 'XLUw_s1', H_XLUwpts), 
	    ('HallA 15', 'XUUw_c0', H_XUUw0pts),
            ('HallA 15', 'XUUw_c1', H_XUUw1pts),
	    ('HallA 17', 'XUUw_c0', H17_XUUw0pts),
            ('HallA 17', 'XUUw_c1', H17_XUUw1pts)
            ]
    sets[10] = [
            ('H1ZEUS', 'X_DVCS', H1ZEUS), 
            ('HERMES', 'ALUI', ALUIpts),
    ...
    sets[11] = [
	    ...
	    ('HallA 17', 'XUUw_c0', H17_XUUw0pts),
            ('HallA 17', 'XUUw_c1', H17_XUUw1pts),
	    ('HallA 20', 'nXUUw_c0', H20_nXUUw0pts),
	    ('HallA 20', 'nXUUw_c1', H20_nXUUw1pts)
            ]
