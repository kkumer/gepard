...
#pragma aux CDVCSF "^"  /* For Watcom compiler, GCC ignores it */
void CDVCSF(int *nf, Doublecomplex *j, 
                double *rf2, double *rr2, 
                Doublecomplex bigc0[2],
                Doublecomplex bigc1[2],
                Doublecomplex bigc2[2]);
...
void cdvcs(void)
{
        ...
        double rf2, rr2;
        Doublecomplex j;
        Doublecomplex bigc0[2], bigc1[2], bigc2[2];
...
/* calling FORTRAN  function  */
        CDVCSF(&nf, &j, &rf2, &rr2, bigc0, bigc1, bigc2);
 ...
 */
        MLPutFunction(stdlink, "List", 3);
                ...
                MLPutFunction(stdlink, "List", 2);
                        mlputcomplex(stdlink, bigc2[0]);
                        mlputcomplex(stdlink, bigc2[1]);
