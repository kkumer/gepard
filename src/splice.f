...
C
     ...
     &  -PAR(12))*(5-PAR(12))*(6-PAR(12))*(7-PAR(1
     &  2))*(8-PAR(12))*(9-PAR(12))*(1/(1-DEL2/(PA
     &  R(14)+j*PAR(15))))**PAR(16)*(1/(1+j-PAR(12
     &  )-DEL2*PAR(13))+2**(-1-j+PAR(12)+DEL2*PAR(
     &  13))*Pi*xi**(1+j-PAR(12)-DEL2*PAR(13))*PAR
     &  (19)*(DCTAN((Pi*(j-PAR(12)-DEL2*PAR(13)))/
     &  2.d0)+1/tan((Pi*(-PAR(12)-DEL2*PAR(13)))/2
     &  .d0))))/((2+j-PAR(12))*(3+j-PAR(12))*(4+j-
     &  PAR(12))*(5+j-PAR(12))*(6+j-PAR(12))*(7+j-
     &  PAR(12))*(8+j-PAR(12))) 
                FCM(2)=(PAR(21)*(2-PAR(22))*(3-PAR(22))*(4
     &  -PAR(22))*(5-PAR(22))*(6-PAR(22))*(7-PAR(2
     &  2))*(1/(1-DEL2/(PAR(24)+j*PAR(25))))**PAR(
     &  26)*(1/(1+j-PAR(22)-DEL2*PAR(23))+2**(-1-j
     &  +PAR(22)+DEL2*PAR(23))*Pi*xi**(1+j-PAR(22)
     &  -DEL2*PAR(23))*PAR(29)*(DCTAN((Pi*(j-PAR(2
     &  2)-DEL2*PAR(23)))/2.d0)+1/tan((Pi*(-PAR(22
     &  )-DEL2*PAR(23)))/2.d0))))/((2+j-PAR(22))*(
     &  3+j-PAR(22))*(4+j-PAR(22))*(5+j-PAR(22))*(
     &  6+j-PAR(22))) 
      ENDIF
