...
ansatz including skewness dependence.\footnote{Presently, \texttt{FIT} has
$\beta_S + 1 = 9$ and $\beta_{G}+1=7$, while most of the other ansaetze and \texttt{FIT86} have
$\beta_S + 1 = 8$ and $\beta_{G}+1=6$.}
...
\texttt{fit.cmd} and results will go to \texttt{dvcsnlo.out} and \texttt{dvcsnlo.ps} (as well as \texttt{OUTFILE.mnt}).
