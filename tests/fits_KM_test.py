...
class KM09(g.eff.DipoleEFF, g.cff.DispersionFixedPoleCFF, g.dvcs.hotfixedBMK):
    pass
...
class KM10(g.eff.DipoleEFF, g.gpd.PWNormGPD, g.cff.HybridFreePoleCFF, g.dvcs.BM10):
	pass

class KM10b(g.eff.KellyEFF, g.gpd.PWNormGPD, g.cff.HybridFreePoleCFF, g.dvcs.BM10):
	pass
...
class KM15(g.eff.KellyEFF, g.gpd.PWNormGPD, g.cff.HybridFreePoleCFF, g.dvcs.BM10tw2):
    pass
...
def test_KM09a(th_KM09):
    """Test model: KM09a."""
    th_KM09.parameters.update(par_KM09a)
    chisq = th_KM09.chisq(GLOpoints)
    assert chisq == approx(32.044069303618073)


def test_KM09b(th_KM09):
    """Test model: KM09b."""
    th_KM09.parameters.update(par_KM09b)
    pts = GLOpoints + g.data.dset[30]
    chisq = th_KM09.chisq(pts)
    assert chisq == approx(33.36747338543438)


@mark.slow
def test_KM10(th_KM10):
    """Test model: KM10."""
...
def test_KM10a(th_KM10):
    """Test model: KM10a."""
    th_KM10 = db['KM10a']
    pts = H1ZEUSpoints+ALTGLOpoints
    chisq = th_KM10.chisq(pts)[0]
